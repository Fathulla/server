...
// Create
router.post("/", upload_1.upload.single("img"), // Используем middleware для загрузки одного файла
(req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const event = yield privateEventModel_1.PrivateEvent.create(Object.assign(Object.assign({}, body), { img: fileUrl }));
...
router.get("/", (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const events = yield privateEventModel_1.PrivateEvent.findAll();
        res.json(events);
    }
    catch (error) {
...
router.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const event = yield privateEventModel_1.PrivateEvent.findByPk(req.params.id);
        if (event) {
            res.json(event);
        }
        else {
...
router.put("/:id", upload_1.upload.single("img"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const event = yield privateEventModel_1.PrivateEvent.findOne({
...
router.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const deleted = yield privateEventModel_1.PrivateEvent.destroy({
            where: { id: req.params.id },
        });
        if (deleted) {
